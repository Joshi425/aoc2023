                ...
                for y_offset in [-1,0,1]:
                        ...
                        if content[current_x+x_offset][current_y+y_offset].isdigit():
                            ...
                            while content[current_x+x_offset][current_y+temp_y].isdigit():
                                ...
                                temp_y+=1
                            if char == "*" and current_number not in numbers[current_x][current_y]:
                              numbers[current_x][current_y].append(current_number)
...
for x in numbers:
    for y in numbers[x]:
        if len(numbers[x][y]) == 2:
            sum+=int(numbers[x][y][0])*int(numbers[x][y][1])
